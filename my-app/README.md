# command to spin up supertokens engine the right way

docker run -it --name st-engine -p 3567:3567 -e API_KEYS="this-is-key-1-for-supertokens,this-is-key-2-for-supertokens" -d supertokens/supertokens-postgresql:latest-amd64

# on a linux environment

curl --location --request POST 'http://localhost:3567/recipe/dashboard/user' ^
--header 'rid: dashboard' ^
--header 'api-key: this-is-key-1-for-supertokens' ^
--header 'Content-Type: application/json' ^
--data-raw '{"email": "my@email.com","password": "password1234"}'

# on windows powershell

Invoke-RestMethod -Method Post "http://localhost:3567/recipe/dashboard/user" `
-Headers @{
    "rid"="dashboard";
    "api-key"="this-is-key-1-for-supertokens";
    "Content-Type"="application/json"
}`
-Body '{"email":"my@email.com","password":"password1234"}'
